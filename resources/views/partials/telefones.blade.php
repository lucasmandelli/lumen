<p>
    <a href="{{ route('telefone.create', ['pessoa_id' => $pessoa->id]) }}" class="label label-primary">Novo Telefone</a>
</p>
<table class="table table-hover">
    @foreach($pessoa->telefones as $telefone)
        <tr>
            ...
            <td>
                <a href="{{ route('telefone.edit', ['id' => $telefone->id]) }}" class="text-info" data-toggle="tooltip" data-placement="top" title="Editar"><i class="fa fa-edit"></i> </a>
